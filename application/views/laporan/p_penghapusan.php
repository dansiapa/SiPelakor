        ...
        <div class="col text-center">
  		...
  		<div class="row">
  			<div class="col text-left">
  				<p>Pada hari ini tanggal <?=tgl_indo(date('Y-m-d'));?> bertempat di <?=$lokasi['nama_lokasi']?> Universitas Samratulangi telah melaksanakan penghapusan aset berupa :</p>
  			</div>
  		</div>
  		<div class="row pt-3">
  			<div class="col text-center">
      ...
      <div class="row">
        <div class="col text-left">
  		...
  		<div class="row pt-4">
  			<div class="col-md-6">
          <p>Mengetahui, </p>
          <p class="ex1">Rektor</p>
          Nama Rektor</br>
          NIP. 
        </div>
        <div class="col-md-6 text-right">
          <p>Tempat, <?=tgl_indo(date('Y-m-d'))?></p>
          <p class="ex1">Wakil Rektor Bidang Umum dan Keuangan</p>
          Nama WR</br>
          NIP. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
  		</div> 			
